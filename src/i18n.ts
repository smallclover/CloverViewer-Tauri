...
const zh: Dict = {
  ...
  "shot.scrollAutoMode": "自动滚动",
  "shot.scrollManualModeShort": "手动滚动",
  "shot.scrollAutoHint": "自动查找滚动位置并连续拼接。",
  "shot.scrollManualHint": "由你控制滚动位置，我会持续收集画面。",
...
const en: Dict = {
  ...
  "shot.scrollAutoMode": "Automatic",
  "shot.scrollManualModeShort": "Manual",
  "shot.scrollAutoHint": "Find the scroll position and stitch continuously.",
  "shot.scrollManualHint": "You control scrolling while I collect the frames.",
